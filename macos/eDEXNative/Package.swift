...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(
            name: "eDEXNative",
            dependencies: ["AudioSupport", "BorderSupport", "ClockSupport", "CpuinfoSupport", "HardwareSupport", "LayoutSupport", "ModalSupport", "RamwatcherSupport", "SysinfoSupport", "ThemeSupport"],
            path: ".",
            exclude: [
                "README.md",
                "Scripts",
